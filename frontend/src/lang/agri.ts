...
const strings = new LocalizedStrings({
  ...
  en: {
    ...
    COVER: 'Book your Vehicle today!', //
    SUPPLIERS_TITLE: 'Connecting you to the Biggest Brands',
    MAP_TITLE: 'Map of Vehicle Rental Locations',//
    ...
    CAR_SIZE_TITLE: 'Meet Some of Our Vehicle Varients', //
    CAR_SIZE_TEXT: 'Our vehicles come in three Varients.',//
    MINI: 'Tractor',//
    MIDI: 'Harvesting Machines',//
    MAXI: 'Cultivation Machines', //
    SEARCH_FOR_CAR: 'Search for a Vehicles',//

    TITLE: 'Top Vehicle Rental Deals',//
    SUBTITLE: 'Compare our prices and book your Vehicle today!',//
    ...
    SERVICES_FLEET: "From compact city Vehicles to luxury SUVs, our distinctive fleet caters to every travel need. Whether it's business or leisure, we have the perfect car for your trip.",
    SERVICES_FLEXIBLE_TITLE: 'Flexible Pick-Up & Drop-Off',
    SERVICES_FLEXIBLE: "Offering convenient locations and flexible scheduling, we make renting a Vehicle hassle-free. Whether you're arriving a city or an International Airport, your vehicle will be ready when you are.",
